...
/* @var $searchModel app\models\DiplomSearch */
            ...
            [
                ...
                'buttons'=>[
                    'view'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['/diplom_record/view','id'=>$model['id']]);
                        return \yii\helpers\Html::a( ' <span class="btn btn-primary">Просмотр</span>', $customurl,
                            ['title' => Yii::t('yii','View')]);
                    },
                    'update'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['/diplom_record/update','id'=>$model['id']]);
